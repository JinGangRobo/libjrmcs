...
class UartDescriptors {
    static constexpr UartDescriptor kArray[]{
        UartDescriptor{data::DataId::kUartDbus}, UartDescriptor{data::DataId::kUart0},
        UartDescriptor{data::DataId::kUart1},    UartDescriptor{data::DataId::kUart2},
        UartDescriptor{data::DataId::kUart3},
    };
